...
namespace Fishing
{
    ...
    public partial class FishingLocationPage : ContentPage
    {
        ...
        protected async override void OnAppearing()
        {
            ...
            SKSizeI newImageSize = new SKSizeI((int)(originalBitmap.Width * imageScale), (int)(originalBitmap.Height * imageScale));
        ...
        private void DrawMarker(SKCanvas canvas, Models.FishModel fish)
        {
            ...
            if (annotationType == AnnotationDisplayType.Center)
            {
                ...
                canvas.DrawLine(markerPos, new SKPoint(markerPos.X, markerPos.Y - lineLength), linePaint);
            }
        ...
        public int ScrollPosition
        {
            ...
            {
                // math.clamp
                var clamped = Math.Min(backgroundBitmap.Width - Panorama.CanvasSize.Width, Math.Max(0, value));
        ...
        private void AnimateToFish(FishModel fish)
        {
            ...
            var movement = new Animation(callback: (v) => ScrollPosition = (int)v, start: startPos, end: endPos.X, easing: Easing.SpringOut);

            var startPop = Popup.TranslationY;
            var endPop = 0;
            var popup = new Animation((v) => Popup.TranslationY = v, startPop, endPop, Easing.SpringOut);
